...
func TestArticle(t *testing.T) {
	routePaths := [][]string{
		{http.MethodPost, "http://127.0.0.1:8080/api/v1/articles"},
		{http.MethodDelete, "http://127.0.0.1:8080/api/v1/articles/1"},
		{http.MethodPut, "http://127.0.0.1:8080/api/v1/articles/1"},
		{http.MethodGet, "http://127.0.0.1:8080/api/v1/articles/1"},
		{http.MethodGet, "http://127.0.0.1:8080/api/v1/articles"},
	}
	r := routers.NewRouter()
